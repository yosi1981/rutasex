        ...
        <div style="float:left;padding-top:98px;">
            <div id="thumbnail-slider">
                <div class="inner">
                    ...
                    <img class="thumb" src="{{ asset('img/1.jpg') }}" style="height:auto;" />
                    </li>
                    <li>
                    <img class="thumb" src="{{ asset('img/7.jpg') }}" style="height:auto;" />
                    </li>
                    <li>
                    <img class="thumb" src="{{ asset('img/gift2.gif') }}" style="height:auto;" />
                    </li>
                        <li>
